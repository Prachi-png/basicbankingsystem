    ...
    <body class="modal-open summary-sec" style="background: white; overflow:hidden;">
        ...
        ?>
                ...
                <div class="none" style="margin: 100px auto auto 45%;">
                    ...
                    <a href="/jansevabank/beneficiaries.php" style="margin: 10% 30% auto 30%;" class="button">Go Back</a>
                </div>
        <?php }
                ...
                <div class="flex-container-bb">
                    <div class="back_button">
                        <a href="/jansevabank/beneficiaries.php" style="margin: auto 20px;" class="button">Go Back</a>
                    </div>
                </div>
    <?php   }
